...
ElectricalAppliances.prototype.getPowerConsumption = function (power, time, connect) {
  let turnOn = connect;
  if(connect === 1){
    turnOn = 'Вкл';
  }else{
...
function Characteristic(name, color, properties) {
  this.name = name
    this.color = color
      this.properties = properties
}

Characteristic.prototype = new ElectricalAppliances();

const computer = new Characteristic ('Computer', 'black', 'GTX960M');
